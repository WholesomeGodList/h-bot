...
public class BadTags {
	...
	public static MessageEmbed getBadTagEmbed() {
		...
		ArrayList<String> illegalTagList = new ArrayList<>(TagList.getIllegalTags());
		Collections.sort(illegalTagList);
		badTagEmbed.addField("Illegal tags:", String.join("\n", illegalTagList), false);
